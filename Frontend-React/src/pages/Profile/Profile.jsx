            ...
            <div className="lg:flex gap-32">
              <div className="space-y-7">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"Rahul Krishna"} </p>
                </div>
                <div className="flex">
              ...
              <div className="space-y-7">
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"Earth"} </p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">City : </p>
                  <p className="text-gray-500">{"Solar System"} </p>
                </div>
                <div className="flex">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"Universe"} </p>
                </div>
              </div>
            </div>
          </CardContent>
